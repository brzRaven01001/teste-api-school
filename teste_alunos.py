...
class AlunosTestCase(unittest.TestCase):
    ...
    def test_001_adiciona_alunos(self):
        ...
        r_1 = requests.post('http://127.0.0.1:5000/alunos/criar', json={'id': 1, 'nome': 'João', 'idade': 18, 'data_nascimento': '20/02/2007',"nota_primeiro_semestre": 9,"nota_segundo_semestre": None,"media_final": None})
        r_2 = requests.post('http://127.0.0.1:5000/alunos/criar', json={'id': 2, 'nome': 'Catia', 'idade': 28, 'data_nascimento': '12/08/1996',"nota_primeiro_semestre": 10,"nota_segundo_semestre": None,"media_final": None})
